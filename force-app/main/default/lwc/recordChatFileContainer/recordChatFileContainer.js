...
import getVersionFiles from "@salesforce/apex/contentManager.getDocumentFiles";

export default class RecordChatFileContainer extends NavigationMixin(LightningElement) {
    loaded = false;
    @track fileList;
    @api recordId;
